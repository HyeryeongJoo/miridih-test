...
# def merge_files(output_directory):
#     output_file = 'final_result.txt'  # Default output file name
#     total_input_tokens = 0  # Initialize total input tokens
#     total_output_tokens = 0  # Initialize total output tokens
#     try:
#         # Ensure the directory exists
#         if not os.path.exists(output_directory):
#             print(f"The directory '{output_directory}' does not exist.")
...
#                         # Extract input and output tokens using regex
#                         input_match = re.search(r'Input tokens: (\d+)', content)
#                         output_match = re.search(r'Output tokens: (\d+)', content)
                        
#                         if input_match:
#                             total_input_tokens += int(input_match.group(1))
#                         if output_match:
#                             total_output_tokens += int(output_match.group(1))

#             # Write total tokens at the end of the output file
#             outfile.write(f"\n\nTotal Input Tokens: {total_input_tokens}\n")
#             outfile.write(f"Total Output Tokens: {total_output_tokens}\n")

#         print(f"All files have been merged into '{output_file}' in the directory '{output_directory}'.")
#         print(f"Total Input Tokens: {merged_total_input_tokens}")
#         print(f"Total Output Tokens: {merged_total_output_tokens}")
